...
class AutoMuterGUI:
    ...
    def create_gui(self):
        ...
        ttk.Button(button_frame, text="Start", command=self._start_from_gui).pack(side=tk.LEFT, padx=5)
        ttk.Button(button_frame, text="Stop", command=self.audio_muter.stop).pack(side=tk.LEFT, padx=5)
        ttk.Button(button_frame, text="Test Mute", command=self.audio_muter.toggle_mute).pack(side=tk.LEFT, padx=5)
